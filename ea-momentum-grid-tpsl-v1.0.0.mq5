//+---------------------------------------------------------------------+
//|                                  ea-momentum-grid-tpsl-v1.0.0.mq5   |
...
input group "=== BUY TP/SL ==="; 
input int InpBuyNetProfitPoints = 3000; // [Buy] Net Profit Points (points)
input int InpBuySLDistance = 2000; // [Buy] SL Distance from lowest position (0 = No SL)
input int InpBuyTPDistance = 2000; // [Buy] TP Distance from VWAP (0 = No TP)
...
input group "=== SELL TP/SL ==="; 
input int InpSellNetProfitPoints = 3000; // [Sell] Net Profit Points (points)
input int InpSellSLDistance = 2000; // [Sell] SL Distance from highest position (0 = No SL)
input int InpSellTPDistance = 2000; // [Sell] TP Distance from VWAP (0 = No TP)
...
input group "++++++++++ OTHER ++++++++++";
input int      InpMagicNumber = 2025111401;        // Magic Number
input int      InpSlippage = 10; // Slippage (points)
input string   InpTradeComment = "EA_Grid_Momentum_BS_Stop"; // Comment
...
int OnInit()
{
   ...
   handle_stoch = iStochastic(_Symbol, InpStochTF, InpStochK, InpStochD, InpStochSlowing, MODE_SMA, STO_LOWHIGH);
